...
* Java Development Kit 17 (JDK 17) or greater to compile and build your custom Java code.
** For preexisting connectors, (see xref:java-version-support.adoc#jdk_8[JDK 8 might be needed]).
